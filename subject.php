<?php
  ...
  {
    mysql_query("DELETE FROM subject WHERE subjectId=".$_GET['delete_id']);
  ...
  if(isset($_POST['btn-save']))
  {
    ...
    if($_POST['subjectId']){
      ...
      $sql_query = "INSERT INTO subject(subjectCode,subjectName,subjectCredits,isGpa,semester_semesterId,Grade) VALUES('$subjectCode','$subjectName','$subjectCredits','$isGpa','$semester_semesterId','$Grade')";
    ...
    $result_set_sub=mysql_query("SELECT * FROM subject WHERE semester_semesterId=".$semester_semesterId);
    if(mysql_num_rows($result_set_sub)>0)
    {
      while($row=mysql_fetch_row($result_set_sub))
      {
        if($row[4]==1){
          $grde = $row[6];
...
<body>
    ...
    <div class="container"> 
      ...
      <div class="col-md-12"> 
        ...
        <?php
          $result_set=mysql_query("SELECT * FROM semester WHERE users_userId=".$_SESSION['user']);
          if(mysql_num_rows($result_set)>0)
          {
                  ...
                  <div class="modal-body">
                    <form class="" method="post">
                        <div class="form-group">
                          ...
                          <!-- <label for="semester_semesterId">Semester ID</label> -->
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                $result_set_sub=mysql_query("SELECT * FROM subject WHERE semester_semesterId=".$semester);
                if(mysql_num_rows($result_set_sub)>0)
                {
                  while($row=mysql_fetch_row($result_set_sub))
                  {
