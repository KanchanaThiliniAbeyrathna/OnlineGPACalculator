<?php
  ...
  {
    mysql_query("DELETE FROM semester WHERE semesterId=".$_GET['delete_id']);
    header("Location: semester.php");
  }

  if(isset($_GET['edit_id']))
  {
    $result_set=mysql_query("SELECT * FROM semester WHERE semesterId=".$_GET['edit_id']);
      ...
      <form class="form-inline" method="post">
        ...
        ?>
          <div class="form-group">
            <label for="semesterName">Semster Name</label>
            <input type="semesterName" class="form-control" name="semesterName" value="<?php echo $fetched_row['semesterName']; ?>" required >
          </div>
        ...
        ?>
          <div class="form-group">
            <label for="semesterName">Semster Name</label>
            <input type="semesterName" class="form-control" name="semesterName">
          </div>
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th><center>View Sujects</center></th>
            </tr>
          </thead>
          <tbody>
            <?php
